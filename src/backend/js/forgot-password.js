...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    let originalText = forgotPassBtn.innerHTML;

    forgotPassBtn.disabled = true;
    forgotPassBtn.innerHTML = `
    ...
    try {
      let response = await fetch("backend/php/forgot-password.php", {
        method: "POST",
        body: formData,
      });
    ...
    forgotPassBtn.innerHTML = originalText;
