...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    let originalText = resetPassBtn.innerHTML;

    resetPassBtn.disabled = true;
    resetPassBtn.innerHTML = `
    ...
    try {
      let response = await fetch("backend/php/reset-password.php", {
        method: "POST",
        body: formData,
      });
    ...
    resetPassBtn.innerHTML = originalText;
