...
<body class="dark:bg-gray-800 bg-gray-200 dark:text-white">
    <div class=" flex h-screen">
        ...
        <div class="flex-1 flex flex-col px-6 ">
            ...
            <div class="py-4 flex justify-between items-end mb-10">
                <p class="uppercase text-blue-600 dark:text-green-600 font-bold text-xl">quizzes</p>
                <div class="flex gap-4 justify-between">
                    <button data-modal-target="quiz-modal" data-modal-toggle="quiz-modal"
            ...
            <div class="mb-4 flex items-center gap-4">
                <div class="w-full">Select or search for any quiz to start learning</div>
                <div class="w-full">
                    <form class="max-w-md mx-auto" method="post">
                        <div class="relative">
                            ...
                            <input type="search" id="default-search"
                                ...
                                placeholder="Search quiz..." required autocomplete="off" />
                            <button type="submit" id="searchQuizButton"
            ...
            <div class="overflow-y-auto mt-4">
                <main class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6" id="quizDiv">
    ...
    <script>
        ...
        const durationStatus = document.getElementById('quizType');
        const durationFields = document.getElementById('quizDurationFields');
        ...
        durationStatus.addEventListener('change', function () {
            if (this.value === 'Timed') {
