    ...
    <div class=" flex h-screen">
        ...
        <div class="flex-1 flex flex-col px-6 ">
            ...
            <div class="mb-4 md:flex items-center gap-4">
                <div class="w-full text-xs md:text-base mb-3 md:mb-0">Select or search for any quiz to start learning
                </div>
                <div class="w-full">
            ...
            <div class="overflow-y-auto mt-4">
                <main class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6" id="quizDiv">
